...
class SKButton: SKSpriteNode {
     ...
     */
    var buttonFunc: ((_ button: SKButton) -> Void)?
     ...
     * Init
     */
    init(normalImageNamed: String, highlightedImageNamed: String? = nil, disabledImageNamed: String? = nil, size: CGSize? = nil, buttonFunc: ((_ button: SKButton) -> Void)? = nil) {
        let record = Record()
    ...
    init(normalTexture: SKTexture, highlightedTexture: SKTexture? = nil, disabledTexture: SKTexture? = nil, buttonFunc: ((_ button: SKButton) -> Void)? = nil) {
        let record = Record()
    ...
    init(normalString: String, normalFontName: String? = nil, normalFontSize: CGFloat? = nil, normalStringColor: UIColor? = nil, backgroundNormalColor: UIColor? = nil, size: CGSize? = nil, cornerRadius: CGFloat? = nil, buttonFunc: ((_ button: SKButton) -> Void)? = nil) {
        let record = Record()
